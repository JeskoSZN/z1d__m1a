...
public class Recources {
    ...
    static Texture cannon_fire_button = new Texture(Gdx.files.internal( "FireCannonIcon.png"));
    static Texture cannon_super_button = new Texture(Gdx.files.internal( "SuperCannonIcon.png"));
    static Texture cannon_double_button = new Texture(Gdx.files.internal( "doubleCannonIcon.png"));
    static Texture cannon_laser_button = new Texture(Gdx.files.internal( "laserCannonIcon.png"));
    ...
    static Texture muzzleflash = new Texture(Gdx.files.internal( "muzzleflash.png"));
