...
public class Effect {
    ...
    Effect(String type, int x, int y){
        ...
        w = (Tables.resources.get("effect_" + type) == null ? Recources.click : Tables.resources.get("effect_" + type)).getWidth() / cols;
        h = (Tables.resources.get("effect_" + type) == null ? Recources.click : Tables.resources.get("effect_" + type)).getHeight() / rows;
        this.x = x - w / 2;
        this.y = y - h / 2;
        init_animations();
    }
    ...
    void init_animations(){
        ...
        TextureRegion[][] sheet = TextureRegion.split(
                (Tables.resources.get("effect_" + type) == null ? Recources.click : Tables.resources.get("effect_" + type)),
                w,
                h
        );
